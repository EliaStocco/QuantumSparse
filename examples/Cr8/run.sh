...
diagonalize           -io tmp/H.spin-cyl-H.pickle -o H.spin-cyl-H-diag-wo-sym.pickle
...
diagonalize           -io tmp/H.spin-H-U.pickle -o H.spin-H-U-diag-wo-sym.pickle
...
construct_hamiltonian -is ${folder} -j ${data} -o tmp/H.spin-H.pickle
diagonalize           -io tmp/H.spin-H.pickle -o tmp/H.spin-H-diag-wo-sym.pickle
...
construct_hamiltonian -is ${folder} -j ${data} -o tmp/H.spin-H.pickle
diagonalize           -io tmp/H.spin-H.pickle -o tmp/H.spin-H-diag-with-sym.pickle -s tmp/D.cart.pickle
...
diagonalize           -io tmp/H.spin-H-U.pickle -o H.spin-H-U-diag-with-sym.pickle -s tmp/D.cyl.pickle
